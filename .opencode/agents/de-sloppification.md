...
2. **Read standards**:
   - Read AGENTS.md.
   - Read relevant docs for every area you touch (see the Documentation Landscape in docs.md).
3. **Establish scope**:
...
If a cleanup spans multiple modules, refer to AGENTS.md for project conventions and use `npm run lint` / `npm run test` for validation.
